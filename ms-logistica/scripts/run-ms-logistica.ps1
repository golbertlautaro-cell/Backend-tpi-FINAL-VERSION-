# Run script for ms-logistica: kills any process listening on the configured port and starts the service
$port = 8081
...
Write-Host "Starting ms-logistica (mvn -DskipTests spring-boot:run)..."
