...
class TramoServiceTest {
    ...
    void setUp() {
        ...
        solicitudTest.setNroSolicitud(1L);
        ...
        tramoTest.setSolicitud(solicitudTest);
    }
    ...
    void testCrearTramo_Success() {
        ...
        assertNotNull(result);
        assertEquals(1L, result.getIdTramo());
        assertEquals(solicitudTest.getNroSolicitud(), result.getSolicitud().getNroSolicitud());
    ...
    void testCrearTramo_SolicitudNotFound() {
        ...
        verify(tramoRepository, never()).save(any());
    }
    ...
    void testListarPorSolicitud_Success() {
        ...
        when(tramoRepository.findBySolicitudNroSolicitud(1L, pageable)).thenReturn(pageExpected);
        ...
        assertEquals(1, result.getTotalElements());
        assertEquals(1, result.getContent().size());
        verify(tramoRepository, times(1)).findBySolicitudNroSolicitud(1L, pageable);
    }
