...
public class GoogleMapsService {
    ...
    /**
     * Constructor que inyecta el WebClient configurado.
     * 
     * @param googleMapsWebClient WebClient configurado con la URL base de Google Maps
     */
    public GoogleMapsService(@Autowired(required = false) @Qualifier("googleMapsWebClient") WebClient googleMapsWebClient) {
    ...
    public DistanciaDTO calcularDistancia(String origen, String destino) {
        ...
        // Si no tenemos WebClient disponible, retornar valores por defecto
